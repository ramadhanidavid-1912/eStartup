...
<body>
  ...
  <header id="header" class="header header-hide">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#body" class="scrollto"><span>A</span>NGGOTA</a></h1>
  ...
  <section id="contact" class="padd-section wow fadeInUp">
    ...
    <div class="container">
      <div class="section-title text-center">
        <h2>ANGGOTA</h2>
        <p class="separator">MASUKKAN DATA ANGGOTA</p>
      </div>
    </div>
	<form method="POST" action="3insert_anggota.php">
	<table>
		<tr>
			<td> NIM </td>
		...
		<tr>
			...
			<td> <select name ="jurusan">
							...
							<option>Akuntansi komputerisasi</option>
							<option>Humas</option>
							</select>
		</tr>
		...
		<tr>
			<td> STATUS </td>
			<td> <input type="text" name="statusanggota" value="Anggota"> </td>
		</tr>
		...
		<tr>
			<td> NO HP </td>
			<td> <input type="text" name="nohpanggota"> </td>
		</tr>
		<tr>
			<td> ALAMAT </td>
