...
<body>
  ...
  <header id="header" class="header header-hide">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#body" class="scrollto"><span>B</span>UKU</a></h1>
  ...
  <section id="contact" class="padd-section wow fadeInUp">
    ...
    <div class="container">
      <div class="section-title text-center">
        <h2> EDIT BUKU</h2>
        <p class="separator">EDIT DATA BUKU</p>
      </div>
    </div>
	<?php $id_dua = $_GET['iddua'];
	$query = mysqli_query($koneksi, "SELECT * FROM buku WHERE id_buku ='$id_dua'");
	$m = mysqli_fetch_array($query);
	 ?>

<form method="POST" action="4olah_edit.php">
		<table>
		<tr>
		<td>ID BUKU </td>
		<td><input type="text" name="idbukuform" value="<?php print $m['id_buku']; ?>" width="100%" /></td>
		</tr>
		<tr>
		<td>JUDUL BUKU </td>
		<td><input type="text" name="judulbukuform" value="<?php print $m['judul_buku']; ?>" width="100%" /></td>
		</tr>
		<tr>
		<td>PENGARANG</td>
		<td><input type="text" name="pengarangform" value="<?php print $m['pengarang']; ?>" width="100%" /></td>
		</tr>
		<tr>
		<td>PENERBIT</td>
		<td><input type="text" name="penerbitform" value="<?php print $m['penerbit']; ?>" width="100%" /></td>
		</tr>
		<tr>
		<td>TAHUN TERBIT</td>
		<td><input type="text" name="tahunterbitform" value="<?php print $m['tahun_terbit']; ?>" width="100%" /></td>
		</tr>
		<tr>
		<td>STOK </td>
		<td><input type="text" name="stokform" value="<?php print $m['stok']; ?>" width="100%" />	
			</select></td>
		</tr>
		<tr>
