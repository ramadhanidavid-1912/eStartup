...
<body>
  ...
  <header id="header" class="header header-hide">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#body" class="scrollto"><span>O</span>PERATOR</a></h1>
  ...
  <section id="contact" class="padd-section wow fadeInUp">
    ...
    <div class="container">
      <div class="section-title text-center">
        <h2>EDIT OPERATOR</h2>
        <p class="separator">EDIT DATA OPERATOR</p>
      </div>
    </div>
	<?php
	$id_awal = $_GET['idawal'];
	$query = mysqli_query($koneksi, "SELECT * FROM operator WHERE id_operator ='$id_awal'");
	$m = mysqli_fetch_array($query);
	 ?>

<form method="POST" action="1olah_edit.php">
		<table>
		<tr>
		<td>Id Operator </td>
		<td><input type="text" name="idoperator" value="<?php print $m['id_operator']; ?>" width="100%" /></td>
		</tr>
		<tr>
		<td>Nama </td>
		<td><input type="text" name="namaoperator" value="<?php print $m['nama_operator']; ?>" width="100%" /></td>
		</tr>
		<tr>
		<td>Status </td>
		...
		<tr>
		<td>Password</td>
		<td><input type="password" name="password" value="<?php print $m['password']; ?>" width="100%" /></td>
		</tr>
		<tr>
		<td>No HP </td>
		<td><input type="text" name="nohp" value="<?php print $m['no_hp']; ?>" width="100%" />	
			</select></td>
		</tr>
		<tr>
