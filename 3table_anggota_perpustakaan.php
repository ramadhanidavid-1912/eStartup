...
<body>
  ...
  <section id="contact" class="padd-section wow fadeInUp">
    ...
    <div class="container">
      <div class="section-title text-center">
        <h2>TABLE ANGGOTA</h2>
        <p class="separator">DATA ANGGOTA</p>
      </div>
    </div>
	<a href="3form_anggota.php"> TAMBAH DATA</a><br><br>
		<?php
			include "koneksi_perpustakaan.PHP";
		?>
		...
		<tr>
			...
			<td><a href="3edit_anggota.php?nimawal=<?php echo $m['nim']; ?>"> Edit </a> | <a href="3hapus_anggota.php?nimawal=<?php echo $m['nim']; ?>"> Hapus </a> </td>
