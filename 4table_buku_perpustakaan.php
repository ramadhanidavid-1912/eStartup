...
<body>
  ...
  <section id="contact" class="padd-section wow fadeInUp">
    ...
    <div class="container">
      <div class="section-title text-center">
        <h2> TABLE BUKU</h2>
        <p class="separator">DATA BUKU</p>
      </div>
    </div>
	<a href="4form_buku.php">  TAMBAH DATA</a><br><br>
		<?php
			include "koneksi_perpustakaan.PHP";
		?>
		...
		<tr>
			...
			<td><?php print $m['pengarang'];?></td>
			<td><?php print $m['penerbit'];?></td>
			<td><?php print $m['tahun_terbit'];?></td>
			<td><?php print $m['stok'];?></td>
			<td><a href="4edit_buku.php?iddua=<?php echo $m['id_buku']; ?>"> Edit </a> | <a href="4hapus_buku.php?iddua=<?php echo $m['id_buku']; ?>"> Hapus </a> </td>
