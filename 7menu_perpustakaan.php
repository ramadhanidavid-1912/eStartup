...
<body>
  ...
  <header id="header" class="header header-hide">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#body" class="scrollto"><span>M</span>ENU</a></h1>
  ...
  <section id="contact" class="padd-section wow fadeInUp">
    ...
    <div class="container">
      <div class="section-title text-center">
        <h2>MENU </h2>
        <p class="separator">MENU PERPUSTAKAAN</p>
      </div>
    </div>
	<a href="3table_anggota_perpustakaan.php"> ANGGOTA</a><br><br><br><br>
	<a href="4table_buku_perpustakaan.php"> BUKU</a><br><br><br><br>
	<a href="5table_peminjaman_perpustakaan.php"> PEMINJAMAN</a><br><br><br><br>
