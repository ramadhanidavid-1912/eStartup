...
<body>
  ...
  <section id="contact" class="padd-section wow fadeInUp">
    ...
    <div class="container">
      <div class="section-title text-center">
        <h2> PEMINJAMAN</h2>
        <p class="separator">MASSUKAN DATA PEMINJAMAN</p>
      </div>
    </div>
	<form method="POST" action="5insert_peminjaman.php">
	<table>
		<tr>
			<td> ID PEMINJAMAN </td>
			<td> <input type="text" name="idpeminjaman"> </td>
		</tr>
		<tr>
			<td> NIM </td>
			<td> <input type="text" name="nimanggota"> </td>
		</tr>
		
		<tr>
			<td> ID BUKU </td>
			<td> <input type="text" name="idbuk"> </td>
		</tr>
		
		<tr>
			<td> TANGGAL PEMINJAMAN </td>
			<td> <input type="date" name="tglpeminjaman"> </td>
		</tr>
		
		<tr>
			<td> LAMA PEMINJAMAN </td>
			<td> <input type="text" name="lamapeminjaman"> </td>
		</tr>
		<tr>
			<td> TANGGAL PENGENMBALIAN </td>
