  ...
  <section id="contact" class="padd-section wow fadeInUp">
    ...
    <div class="container">
      <div class="section-title text-center">
        ...
        <p class="separator">DATA PEMINJAMAN</p>
      </div>
    </div>
	<a href="5form_peminjaman.php">  TAMBAH DATA </a><br><br>
		<?php
			include "koneksi_perpustakaan.PHP";
		?>
		...
		<tr>
			...
			<td align="center">TANGAL PEMINJAMAN</td>
			<td align="center">LAMA PEMINAJAN</td>
		...
		<tr>
			<td><?php print $i;?></td>
			<td><?php print $m['id_peminjaman'];?></td>
			<td><?php print $m['nim'];?></td>
			<td><?php print $m['id_buku'];?></td>
			...
			<td><a href="5edit_peminjaman.php?idtiga=<?php echo $m['id_peminjaman']; ?>"> Edit </a> | <a href="5hapus_peminjaman.php?idtiga=<?php echo $m['id_peminjaman']; ?>"> Hapus </a> | <a href="5print_perpustakaan.php?idtiga=<?php echo $m['id_peminjaman']; ?>"> Print </a> </td>
...
<a href="7menu_perpustakaan.php"> KEMBALI KE MENU </a><br><br><br><br>
