...
<body>
  ...
  <header id="header" class="header header-hide">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#body" class="scrollto"><span>L</span>OGIN</a></h1>
  ...
  <section id="contact" class="padd-section wow fadeInUp">
    ...
    <div class="container">
      <div class="section-title text-center">
        ...
        <p class="separator">Masukan Data untuk Login</p>
      </div>
    </div>
	<form method="POST" action="2olah_login_operator.php">
	<table align="center">
		<tr>
			<td> ID </td>
  ...
  <!--==========================
    Footer
  ============================-->
    <section id="anggota" class="padd-section wow fadeInUp">
	...
	<form method="POST" action="2olah_login_anggota.php">
	<table align="center">
		<tr>
			<td> NIM </td>
			<td> <input type="text" name="nimform"> </td>
		</tr>
		<tr>
			<td> PASSWORD </td>
			<td> <input type="password" name="passwordanggota"> </td>
		</tr>
			<td> <input type="submit" value="LOGIN"> </td>
		</tr>
