...
<head>
  ...
  <link href="img/applSe-touch-icon.png" rel="apple-touch-icon">
...
<body>
    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="#form_operator.php">Form Operator</a></li>
          <li><a href="#form_anggota.php">Form Anggota</a></li>
  ...
  <section id="contact" class="padd-section wow fadeInUp">
    ...
    <div class="container">
      <div class="section-title text-center">
        <h2>OPERATOR</h2>
        <p class="separator">Input Data Operator</p>
      </div>
    </div>
		...
		<tr>
			<td> ID OPERATOR </td>
			<td> <input type="text" name="idoperator"> </td>
		</tr>
		<tr>
			<td> NAMA OPERATOR </td>
