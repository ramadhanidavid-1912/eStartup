  ...
  <section id="contact" class="padd-section wow fadeInUp">
    ...
    <div class="container">
      <div class="section-title text-center">
        ...
        <p class="separator">DATA OPERATOR</p>
      </div>
    </div>
	<a href="1form_operator.php">  Tambah data</a><br>
		<?php
			include "koneksi_perpustakaan.PHP";
		?>
		...
		<tr>
			...
			<td align="center">ID Operator</td>
		...
		<tr>
			...
			<td><a href="1edit_operator.php?idawal=<?php echo $m['id_operator']; ?>"> Edit </a> | <a href="1hapus_operator.php?idawal=<?php echo $m['id_operator']; ?>"> Hapus </a> </td>
