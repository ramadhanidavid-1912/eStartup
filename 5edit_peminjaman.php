  ...
  <header id="header" class="header header-hide">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <h1><a href="#body" class="scrollto"><span>P</span>PEMINJAMAN</a></h1>
      ...
      <!--<nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="#contact">Login Operator</a></li>
          <li><a href="#anggota">Login Anggota</a></li>
          <!--<li><a href="#form_buku.php">Form Buku</a></li>-->
          <!--<li><a href="#form_peminjaman.php">Form Peminjaman</a></li>-->
        </ul>
  ...
  <section id="contact" class="padd-section wow fadeInUp">
    ...
    <div class="container">
      <div class="section-title text-center">
        ...
        <p class="separator">EDIT DATA PEMINJAMAN</p>
      </div>
    </div>
	<?php $id_tiga = $_GET['idtiga'];
	$query = mysqli_query($koneksi, "SELECT * FROM peminjaman WHERE id_peminjaman ='$id_tiga'");
	$m = mysqli_fetch_array($query);
	 ?>

<form method="POST" action="5olah_edit.php">
		<table>
		<tr>
		<td>ID PEMINJAMAN </td>
		<td><input type="text" name="formidpeminjaman" value="<?php print $m['id_peminjaman']; ?>" width="100%" /></td>
		</tr>
		<tr>
		<td>NIM </td>
		<td><input type="text" name="formnim" value="<?php print $m['nim']; ?>" width="100%" /></td>
		</tr>
		<tr>
		<td>ID BUKU</td>
		<td><input type="text" name="formidbuku" value="<?php print $m['id_buku']; ?>" width="100%" /></td>
		</tr>
		<tr>
		<td>TANGGAL PEMINJAMAN</td>
		<td><input type="date" name="formtglpeminjaman" value="<?php print $m['tgl_peminjaman']; ?>" width="100%" /></td>
		</tr>
		<tr>
		<td>LAMA PEMINJAMAN</td>
		<td><input type="text" name="formlamapeminjaman" value="<?php print $m['lama_peminjaman']; ?>" width="100%" /></td>
		</tr>
		<tr>
		<td>TANGGAL PENGEMBALIAN </td>
		<td><input type="date" name="formtglpengembalian" value="<?php print $m['tgl_pengembalian']; ?>" width="100%" />	
			</select></td>
		</tr>
		<td>JUMLAH </td>
		<td><input type="text" name="formjumlah" value="<?php print $m['jumlah']; ?>" width="100%" />	
			</select></td>
		</tr>
		<tr>
          ...
          <div class="form">
            ...
            <form action="" method="post" role="form" class="contactForm">
              <div class="form-group">
                <input type="text" name="id_operator" class="form-control" />
                <div class="validation"></div>
              </div>
              <div class="form-group">
                <input type="email" class="form-control" name="nama_operator" />
                <div class="validation"></div>
              </div>
              <div class="form-group">
